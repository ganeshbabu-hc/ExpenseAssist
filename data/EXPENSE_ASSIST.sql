...
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Salary", "Income by salary",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"account-cash", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Cash", "Cash Income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Awards", "Awars Income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"award", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Allowance", "Allowance income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"hand-holding-usd", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Bonus", "Bonus income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"sale", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Cashback", "Income by cashback",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-refund", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Capital Gains", "Income by capital gains",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"chart-line", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Sales", "Income by sales",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"business", 0, 'income');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Other", "Other income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-plus", 0, 'income');

-- Transaction categories expense
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Food", "Food related expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"fastfood", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Shopping", "Shopping expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"shopping-bag", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Transport", "Transport related expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"emoji-transportation", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Social", "Social related expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"groups", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Household", "Household expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"store", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Health", "Health expenses like, medical insurance, health checkup",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"local-hospital", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Gift", "Transport related expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"gift", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Education", "Education expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"school", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Beauty", "Beauty/fashion expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"person", 0, 'expense');
INSERT INTO TRANSACTION_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON, EDITABLE, CATEGORY_TYPE) VALUES ("Other", "Other expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-minus", 0, 'expense');

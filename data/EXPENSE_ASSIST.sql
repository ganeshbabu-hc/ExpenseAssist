...
-- Income categories
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Salary", "Income by salary",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"account-cash");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Cash", "Cash Income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Awards", "Awars Income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"award");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Allowance", "Allowance income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"hand-holding-usd");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Bonus", "Bonus income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"sale");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Cashback", "Income by cashback",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-refund");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Capital Gains", "Income by capital gains",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"chart-line");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Sales", "Income by sales",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"business");
INSERT INTO INCOME_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Other", "Other income",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-plus");
...
INSERT INTO EXPENSE_CATEGORIES(TITLE, DESCRIPTION, DATE_ADDED_TLM, DATE_UPDATED_TLM, CATEGORY_ICON) VALUES ("Other", "Other expenses",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"cash-minus");

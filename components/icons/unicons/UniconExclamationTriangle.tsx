...
const UniconExclamationTriangle = (props: Unicon) => {
...
UniconExclamationTriangle.propTypes = uniconPropTypes;
UniconExclamationTriangle.defaultProps = defaultUnicon;

export default UniconExclamationTriangle;

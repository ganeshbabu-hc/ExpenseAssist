...
const UniconExclamationOctagon = (props: Unicon) => {
...
UniconExclamationOctagon.propTypes = uniconPropTypes;
UniconExclamationOctagon.defaultProps = defaultUnicon;

export default UniconExclamationOctagon;

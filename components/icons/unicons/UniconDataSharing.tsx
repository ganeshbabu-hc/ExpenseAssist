...
const UniconDataSharing = (props: Unicon) => {
...
UniconDataSharing.propTypes = uniconPropTypes;
UniconDataSharing.defaultProps = defaultUnicon;

export default UniconDataSharing;

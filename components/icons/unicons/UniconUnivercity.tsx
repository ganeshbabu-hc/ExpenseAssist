...
const UniconUnivercity = (props: Unicon) => {
...
UniconUnivercity.propTypes = uniconPropTypes;
UniconUnivercity.defaultProps = defaultUnicon;

export default UniconUnivercity;

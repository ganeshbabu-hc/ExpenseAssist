...
const UniconCreditCard = (props: Unicon) => {
...
UniconCreditCard.propTypes = uniconPropTypes;
UniconCreditCard.defaultProps = defaultUnicon;

export default UniconCreditCard;

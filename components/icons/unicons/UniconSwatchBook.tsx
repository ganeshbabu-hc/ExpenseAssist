...
const UniconSwatchBook = (props: Unicon) => {
...
UniconSwatchBook.propTypes = uniconPropTypes;
UniconSwatchBook.defaultProps = defaultUnicon;

export default UniconSwatchBook;

...
const UniconMoneyStack = (props: Unicon) => {
...
UniconMoneyStack.propTypes = uniconPropTypes;
UniconMoneyStack.defaultProps = defaultUnicon;

export default UniconMoneyStack;

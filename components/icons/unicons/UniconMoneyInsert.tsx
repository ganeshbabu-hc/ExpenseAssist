...
const UniconMoneyInsert = (props: Unicon) => {
...
UniconMoneyInsert.propTypes = uniconPropTypes;
UniconMoneyInsert.defaultProps = defaultUnicon;

export default UniconMoneyInsert;

...
const UniconEnvolopeDownload = (props: Unicon) => {
...
UniconEnvolopeDownload.propTypes = uniconPropTypes;
UniconEnvolopeDownload.defaultProps = defaultUnicon;

export default UniconEnvolopeDownload;

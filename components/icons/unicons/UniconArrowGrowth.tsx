...
const UniconArrowGrowth = (props: Unicon) => {
...
UniconArrowGrowth.propTypes = uniconPropTypes;
UniconArrowGrowth.defaultProps = defaultUnicon;

export default UniconArrowGrowth;

...
const UniconMoneyWithdraw = (props: Unicon) => {
...
UniconMoneyWithdraw.propTypes = uniconPropTypes;
UniconMoneyWithdraw.defaultProps = defaultUnicon;

export default UniconMoneyWithdraw;

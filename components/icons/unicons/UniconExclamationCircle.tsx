...
const UniconExclamationCircle = (props: Unicon) => {
...
UniconExclamationCircle.propTypes = uniconPropTypes;
UniconExclamationCircle.defaultProps = defaultUnicon;

export default UniconExclamationCircle;

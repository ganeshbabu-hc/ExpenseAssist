...
const Empty = (props: any) => {
  ...
  return (
    <Svg
      ...
      <Circle cx={99.319} cy={546.295} r={9} fill={colors.brandDark} />
      <Path
      ...
      <Circle cx={708.522} cy={545.71} r={9} fill={colors.brandDark} />
      <Path
